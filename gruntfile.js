module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            main: {
                files: [
                    {expand: true, src: ['classes/*'], dest: 'dest/built'},
                    {expand: true, src: ['img/*'], dest: 'dest/built'},
                    {expand: true, src: ['class-feature-editor.php'], dest: 'dest/built'},
                ],
            },
        },
        version: {
            ...
            defaults: {
                src: ['dest/built/class-feature-editor.php']
            }
        },
        compress: {
            main: {
